#
#  Be sure to run `pod spec lint Applivery.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  Native SDK to support Applivery platform. Main features of the SDK are: 
  ...
  * Provide feedback. Your beta testers can upload a screenshot or simply a message, to report bugs or improvements
  ...
  s.author             = { "Alejandro Jiménez Agudo" => "a.j.agudo@gmail.com" }
  # Or just: s.author    = "Alejandro Jiménez Agudo"
  # s.authors            = { "Alejandro Jiménez Agudo" => "a.j.agudo@gmail.com" }
  s.social_media_url   = "https://twitter.com/AleJimenezAgudo"
